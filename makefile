...
OBJS = main.o debug.o init.o timer.o interrupt.o print.o kernel.o
...
init.o: kernel/init.c kernel/init.h kernel/interrupt.h device/timer.h lib/kernel/print.h 
	gcc $(INCLUDE) -c -o $@ $< $(CFLAGS)
